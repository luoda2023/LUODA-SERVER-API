...
const un = "Desktop session not ready", en = "Desktop xsession failed", tn = "Desktop session another user login",
    ...
    cn = "x11 expected", St = "https://LUODA.com/docs/en/manual/linux/#x11-required",
    Cn = "https://LUODA.com/docs/en/", pn = St,
    Bn = "https://github.com/LUODA/LUODA/wiki/Headless-Linux-Support",
    at = {"LUODA docs home": Cn, "LUODA docs x11-required": pn, "LUODA x11 headless": Bn},
...
}, Bt = 21116,defaultIdServerPort = 21116, ia = "rs-ny.LUODA.com";

function Zo() {
    const u = window.location.host;
    if (u.indexOf("LUODA.com") >= 0) return ia;
...
class ta {
    ...
    isSupportVirtualDisplay() {
        ...
        try {
            ...
            return i && this._peerInfo.platform == "Windows" && (n == "LUODA_idd" || n == "amyuni_idd")
        } catch (e) {
    ...
    handleLoginResponse(e) {
        const i = {
            [dn]: {
                ...
                link: "https://LUODA.com/docs/en/manual/linux/#login-screen",
                try_again: !0
            },
    ...
    handlePeerInfo(e) {
        ...
        if (this._peerInfo = e, this._isViewCamera && !this.isSupportViewCamera()) {
            L(e.version) < L("1.3.9") && (e.platform == "Windows" || e.platform == "Linux") ? this.msgbox("error", "Download new version", "upgrade_remote_LUODA_client_to_{1.3.9}_tip") : this.msgbox("error", "Error", "view_camera_unsupported_tip"), this.lcHandlePeerInfo(e), this.close();
            return
        }
...
async function Dr(u) {
    const e = "https://api.LUODA.com/version/latest", {os: i, os_version: n} = lr(), a = Er();
